  ...
  return (
    <div className="space-y-6">
      {!showSubscribe ? (
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            <div className="bg-surface-container-low rounded-xl border border-outline-variant p-5 md:col-span-2"><div className="flex items-start justify-between gap-4"><div><p className="font-label-md text-on-surface-variant text-[11px] uppercase tracking-wide">Subscription Plan</p><p className="font-headline-md font-bold text-primary mt-2">Institution Annual</p></div><span className="shrink-0 rounded-full bg-secondary-container px-3 py-1 text-xs font-label-md text-on-secondary-container">Current</span></div><div className="mt-5"><button type="button" onClick={()=>{setSelectedPlan(''); setShowSubscribe(true)}} className="inline-flex items-center gap-2 border border-primary px-4 py-2 rounded-lg font-label-md text-primary hover:bg-primary-container"><span className="material-symbols-outlined text-[18px]">upgrade</span> Upgrade</button></div></div>
